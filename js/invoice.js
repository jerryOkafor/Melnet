...
$(document).ready(function() {
  ...
  $("#save_invoice").click(function(){
    ...
    saveInvoice(invoiceDate,invoiceNumber,jobNumber,stockcodes,itemDescriptions,quantitys,unitCosts,prices,amountDue,subtotal,total,amountPaid,balanceDue,stockcodes,vat,labourcost);
  ...
  function updateInvoice(amountDue,amountPaid,invoiceID){
	...
	//alert("Saving...");
	$("#alert-pop").html("updating invoice...");
  ...
  function saveInvoice(invoiceDate,invoiceNumber,jobNumber,stockcode,itemDescription,quantity,unitCost,price,amountDue,subtotal,total,amountPaid,balanceDue,invoiceLines,vat,labourcost){
     $.ajax({
      url: "../ubnk/dynamic.php",
      success: function (result) {
	//alert(result);
	...
	$("#popupInfo").popup("open");
      ...
      data: {saveinvoice:"yes",invoiceDate:invoiceDate,
